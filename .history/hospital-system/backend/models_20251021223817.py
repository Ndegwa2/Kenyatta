...
def init_models(db):
    ...
    global User, Department, WorkOrder, Technician, WorkOrderComment, WorkOrderAttachment, Equipment, Ticket, TicketComment, TicketAttachment, Patient, Appointment, Doctor, Notification
