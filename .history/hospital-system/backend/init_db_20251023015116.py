...
def init_database():
    with app.app_context():
        ...
        technician4.set_skills_list(['mechanical', 'hvac', 'boilers', 'elevators'])
        db.session.add(technician4)
        ...
        print("  Mechanical Tech: mechanical@hospital.com / tech123")
