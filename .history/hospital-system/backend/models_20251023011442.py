...
def init_models(db):
    ...
    class User(db.Model, UserMixin):
        ...
        role = db.Column(db.String(50), nullable=False)  # admin, technician, department, patient, maintenance_manager
    ...
    class Department(db.Model):
        ...
        type = db.Column(db.String(50), default='hospital')  # hospital, maintenance
        parent_id = db.Column(db.Integer, db.ForeignKey('department.id'), nullable=True)  # For sub-departments
    ...
    class Technician(db.Model):
        ...
        specialty = db.Column(db.String(50), nullable=True)  # electrical, plumbing, hvac, general
        department_id = db.Column(db.Integer, db.ForeignKey('department.id'), nullable=True)  # Links to maintenance department
        user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False)
