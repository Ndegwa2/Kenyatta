...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isRegistering) {
        ...
        } else if (data.role === 'maintenance_manager') {
          navigate('/maintenance'); // maintenance manager goes to maintenance dashboard
        } else if (data.role === 'technician') {
          // Check technician specialty to route to appropriate dashboard
          if (data.specialty === 'mechanical') {
            navigate('/mechanical'); // mechanical technicians go to mechanical dashboard
          } else {
            navigate('/electrician'); // other technicians go to electrician dashboard
          }
        } else {
  ...
  const sampleCredentials = [
    ...
    { role: 'Mechanical Tech', username: 'mechanical@hospital.com', password: 'tech123' }
  ];
