...
export default function DepartmentDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch department tickets with filters
      const ticketsData = await api.get(`/department/tickets?${queryParams.toString()}`);
              ...
              <Card key={ticket.id} className="mb-4">
                <div className="card__header">
                  ...
                  <div className="flex gap-2">
                    ...
                    <span className={`status-badge category-${ticket.category}`}>{ticket.category.replace('_', ' ')}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-4">
                  ...
                  <div>
                    <strong>Time Sensitivity:</strong> {ticket.time_sensitivity.replace('_', ' ')}
                  </div>
                </div>
